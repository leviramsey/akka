...
The KillrWeather sample illustrates how to use [Akka Cluster Sharding](https://doc.akka.io/libraries/akka-core/current/java/typed/cluster-sharding.html) in Java.
